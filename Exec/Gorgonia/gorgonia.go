...
const loc = "./Assets/Training/MNIST"
...
func main() {
	...
	// the data is in (numExamples, 784). [28x28]
...
func (m *convnet) SaveModel() error {
...
func LoadModel(filename string, g *gorgonia.ExprGraph) (*convnet, error) {
	...
	// It's necessary to assign the graph
	m.g = g
