...
as the foundation for performing advanced std.Vector arithmetic using the num.Real and num.Natural types.
...
string representation of a num.Real above base₁₆ - whereas the underlying placeholder byte slice naturally
"separates" each for the computer.

A num.Real is composed of three components - the whole num.Natural part, the fractional num.Natural part, and
