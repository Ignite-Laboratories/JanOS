...
type VectorUpTo7D[T num.Primitive] interface {
	Vector2D[T] | Vector3D[T] | Vector4D[T] | Vector5D[T] | Vector6D[T] | Vector7D[T]
}

type VectorUpTo6D[T num.Primitive] interface {
	Vector2D[T] | Vector3D[T] | Vector4D[T] | Vector5D[T] | Vector6D[T]
}

type VectorUpTo5D[T num.Primitive] interface {
	Vector2D[T] | Vector3D[T] | Vector4D[T] | Vector5D[T]
}
