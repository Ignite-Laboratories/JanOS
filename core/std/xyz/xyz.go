...
func From[T num.Primitive](x, y, z T, maxX, maxY, maxZ T) std.XYZ[T] {
...
func FromFull[T num.Primitive](x, y, z T, minX, maxX, minY, maxY, minZ, maxZ T) std.XYZ[T] {
...
func Random[T num.Primitive](maxX, maxY, maxZ T) std.XYZ[T] {
...
func RandomFull[T num.Primitive](minX, maxX, minY, maxY, minZ, maxZ T) std.XYZ[T] {
...
func ScaleToType[TIn num.Primitive, TOut num.Primitive](value std.XYZ[TIn]) std.XYZ[TOut] {
	return std.XYZ[TOut]{
