...
func (c RGBA[T]) Set(r, g, b, a T) RGBA[T] {
	c.R = c.R.SetBoundaries(0, T(num.MaxValue[T]())).Set(r)
	c.G = c.G.SetBoundaries(0, T(num.MaxValue[T]())).Set(g)
	c.B = c.B.SetBoundaries(0, T(num.MaxValue[T]())).Set(b)
	c.A = c.A.SetBoundaries(0, T(num.MaxValue[T]())).Set(a)
	return c
}
