...
func From[T num.Primitive](r, g, b, a T) std.RGBA[T] {
...
//	    B: 12 [0xCC] (15 * 0.8)
func FromHex[T num.Primitive](value uint32) std.RGBA[T] {
...
func Random[T num.Primitive]() std.RGBA[T] {
	return std.RGBA[T]{
		R: bounded.Random[T](),
		G: bounded.Random[T](),
		B: bounded.Random[T](),
...
func RandomUpTo[T num.Primitive](maximum T) std.RGBA[T] {
	return std.RGBA[T]{
...
func RandomRange[T num.Primitive](minimum, maximum T) std.RGBA[T] {
	return std.RGBA[T]{
...
func ScaleToType[TIn num.Primitive, TOut num.Primitive](value std.RGBA[TIn]) std.RGBA[TOut] {
