...
func From[TR num.Primitive, TG num.Primitive, TB num.Primitive, TA num.Primitive](r TR, g TG, b TB, a TA) std.RGBAGeneric[TR, TG, TB, TA] {
...
func Random[TR num.Primitive, TG num.Primitive, TB num.Primitive, TA num.Primitive]() std.RGBAGeneric[TR, TG, TB, TA] {
...
func ScaleToType[TInR num.Primitive, TInG num.Primitive, TInB num.Primitive, TInA num.Primitive, TOutR num.Primitive, TOutG num.Primitive, TOutB num.Primitive, TOutA num.Primitive](value std.RGBAGeneric[TInR, TInG, TInB, TInA]) std.RGBAGeneric[TOutR, TOutG, TOutB, TOutA] {
