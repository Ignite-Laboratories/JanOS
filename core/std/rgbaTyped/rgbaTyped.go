...
func From[TR num.Primitive, TG num.Primitive, TB num.Primitive, TA num.Primitive](r TR, g TG, b TB, a TA) std.RGBAAsymmetric[TR, TG, TB, TA] {
	return std.RGBAAsymmetric[TR, TG, TB, TA]{}.Set(r, g, b, a)
}
...
func Random[TR num.Primitive, TG num.Primitive, TB num.Primitive, TA num.Primitive]() std.RGBAAsymmetric[TR, TG, TB, TA] {
	return std.RGBAAsymmetric[TR, TG, TB, TA]{
		R: bounded.Random[TR](),
		G: bounded.Random[TG](),
		B: bounded.Random[TB](),
		A: bounded.Random[TA](),
...
func ScaleToType[TInR num.Primitive, TInG num.Primitive, TInB num.Primitive, TInA num.Primitive, TOutR num.Primitive, TOutG num.Primitive, TOutB num.Primitive, TOutA num.Primitive](value std.RGBAAsymmetric[TInR, TInG, TInB, TInA]) std.RGBAAsymmetric[TOutR, TOutG, TOutB, TOutA] {
	return std.RGBAAsymmetric[TOutR, TOutG, TOutB, TOutA]{
